...
public sealed class HtmlTableChurnReportGenerator : IChurnReportGenerator
{
    ...
    public string Generate(IReadOnlyList<FileChurnResult> results, string subtitle)
    {
        ...
        sb.AppendLine("          <label class=\"filter-label d-block mb-1\" for=\"filter-coverage-op\">Coverage (%)</label>");
        sb.AppendLine("          <div class=\"input-group input-group-sm\">");
        sb.AppendLine("            <select id=\"filter-coverage-op\" class=\"form-select\" data-filter-coverage-op>");
        ...
        sb.AppendLine("            <input id=\"filter-coverage-value\" type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" class=\"form-control\" data-filter-coverage-value placeholder=\"e.g. 70\" />");
        sb.AppendLine("          </div>");
        sb.AppendLine("        </div>");
        sb.AppendLine("        <div class=\"filter-comparison\">");
        sb.AppendLine("          <label class=\"filter-label d-block mb-1\" for=\"filter-churn-op\">Churn risk</label>");
        sb.AppendLine("          <div class=\"input-group input-group-sm\">");
        sb.AppendLine("            <select id=\"filter-churn-op\" class=\"form-select\" data-filter-churn-op>");
        sb.AppendLine("              <option value=\"\">No filter</option>");
        sb.AppendLine("              <option value=\"gt\">Greater than</option>");
        sb.AppendLine("              <option value=\"lt\">Less than</option>");
        sb.AppendLine("            </select>");
        sb.AppendLine("            <input id=\"filter-churn-value\" type=\"number\" step=\"0.0001\" min=\"0\" class=\"form-control\" data-filter-churn-value placeholder=\"e.g. 4.0\" />");
        sb.AppendLine("          </div>");
        sb.AppendLine("        </div>");
